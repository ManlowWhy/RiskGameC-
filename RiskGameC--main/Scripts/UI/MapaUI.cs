...
public partial class MapaUI : Node2D, IAplicaParches, IProcesaComandos
{
	...
	private readonly Dictionary<string, Jugador> _playerById = new(); // ID→JUG
	...
	private string _turnOwnerId = "J1";
	...
	{
		["J1"] = new Color(0.9f, 0.2f, 0.2f),
		["J2"] = new Color(0.2f, 0.4f, 0.9f),
